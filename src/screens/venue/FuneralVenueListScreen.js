// src/screens/venue/FuneralVenueListScreen.js
...
export default function FuneralVenueListScreen({ navigation, userInfo, session, isAuthenticated }) {
  ...
  const sampleVenues = [
    ...
    },
    {
      ...
      reviewCount: 167,
      image: null,
      features: ['주차장', '빈소', '안치실', '휴게공간', '접객실', '화장실', '카페'],
    },
    {
      id: 3,
      name: '평안장례식장',
      location: '서울 종로구',
      priceRange: '100-250만원',
      capacity: '30-100명',
      rating: 4.6,
      reviewCount: 145,
      image: null,
      features: ['주차장', '빈소', '안치실', '휴게공간'],
    },
    {
      id: 4,
      name: '서울대학교병원 장례식장',
      location: '서울 종로구',
      priceRange: '180-350만원',
      capacity: '50-180명',
      rating: 4.9,
      reviewCount: 298,
      image: null,
      features: ['주차장', '빈소', '안치실', '휴게공간', '접객실', '화장실', '편의점'],
    }
  ];

  const filters = [
    { id: 'all', label: '전체' },
    { id: 'budget', label: '150만원 이하' },
    { id: 'mid', label: '150-300만원' },
  ...
  const handleVenuePress = (venue) => {
    navigation.navigate('VenueDetail', { venue, type: 'funeral' });
  };
    ...
    >
      <View style={styles.venueImageContainer}>
        <View style={styles.venuePlaceholder}>
          <Ionicons name="flower-outline" size={40} color={Colors.gray400} />
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.resultHeader}>
        <Text style={styles.resultCount}>총 {sampleVenues.length}개 장례식장</Text>
      ...
      <ScrollView style={styles.venueList} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.loadMoreButton}>
          <Text style={styles.loadMoreText}>더 많은 장례식장 보기</Text>
