...
export const MOBILE_TEMPLATES = [
  ...
  // ─── minimal 카테고리 ───
  {
    ...
    back: {
      ...
      groomName: { x: 61.5, y: 43.1, w: 24, size: 13, color: "#57524C" },
      brideName: { x: 61.5, y: 48, w: 24, size: 13, color: "#57524C" },
  ...
  },
  {
    ...
    back: {
      ...
      groomName: { x: 60, y: 29.7, w: 21, size: 13, color: "#2C2A28" },
      brideName: { x: 60, y: 34.2, w: 21, size: 13, color: "#2C2A28" },
  ...
  },
  {
    ...
    back: {
      ...
      groomParents: { x: 10.2, y: 37.8, w: 36, size: 8.4, color: "#66615A" },
      brideParents: { x: 10.2, y: 48, w: 36, size: 8.4, color: "#66615A" },
      groomName: { x: 10.2, y: 41.7, w: 29, size: 16, color: "#3D3A36" },
      brideName: { x: 10.2, y: 51.6, w: 29, size: 16, color: "#3D3A36" },
  ...
  },
  {
    ...
    back: {
      ...
      groomName: { x: 60, y: 38.6, w: 21, size: 13, color: "#2C2A28" },
      brideName: { x: 60, y: 43, w: 21, size: 13, color: "#2C2A28" },
