...
//       id: 'faq',
//       title: '자주묻는 질문',
//       subtitle: '주최자를 위한 FAQ',
//       description: '행사 준비 중 자주 묻는\n질문들과 답변 모음',
//       icon: 'help-circle',
//       gradient: ['#4A88FF', '#6FA8FF'],
//       screen: 'HostFAQ',
//       badge: '필수',
...
//       id: 'faq',
//       title: '자주묻는 질문',
//       subtitle: '참여자를 위한 FAQ',
//       description: '경조사 참석 시 자주 묻는\n질문들과 답변 모음',
//       icon: 'help-circle',
//       gradient: ['#FF6B6B', '#FF8E8E'],
//       screen: 'ParticipantFAQ',
//       badge: '필수',
//     },
//   ];
...
//     // 준비중인 메뉴 체크
//     if (category.badge === '준비중') {
//       alert('준비중입니다. 곧 서비스될 예정입니다!');
//       return;
//     }
...
//                 style={[
//                   styles.categoryCard,
//                   category.badge === '준비중' && styles.categoryCardDisabled
//                 ]}
...
//                   { backgroundColor: category.badge === '준비중' ? '#999999' : category.gradient[0] }
//                 ]}>
//                   <View style={[
//                     styles.categoryGradientOverlay,
//                     { backgroundColor: category.badge === '준비중' ? '#BBBBBB20' : category.gradient[1] + '20' }
//                   ]} />
//                 </View>
...
//                   category.badge === '준비중' && styles.categoryBadgePreparing
//                 ]}>
