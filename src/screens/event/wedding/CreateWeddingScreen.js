...
// ── 은행 로고 ──
const BANK_LOGOS = {
  NH: require('../../../../assets/BankLogos/NHBank(NH농협은행).png'),
  KB: require('../../../../assets/BankLogos/KBBank(KB국민은행).png'),
  KAKAO: require('../../../../assets/BankLogos/KakaoBank(카카오뱅크).png'),
  SHINHAN: require('../../../../assets/BankLogos/ShinhanJejuBank(신한,제주은행).png'),
  WOORI: require('../../../../assets/BankLogos/WooriBank(우리은행).png'),
  IBK: require('../../../../assets/BankLogos/IBKBank(IBK기업은행).png'),
  HANA: require('../../../../assets/BankLogos/HanaBank(KEB하나은행).png'),
  SAEMAEUL: require('../../../../assets/BankLogos/mono.png'),
  DGB: require('../../../../assets/BankLogos/iMBank(iM뱅크).png'),
  BNK: require('../../../../assets/BankLogos/KyongnamBusanBank(경남,부산은행).png'),
  KBANK: require('../../../../assets/BankLogos/KBank(케이뱅크).png'),
  POST: require('../../../../assets/BankLogos/PostOfficeBank(우체국).png'),
  SH: require('../../../../assets/BankLogos/SHBank(수협은행).png'),
  GWANGJU: require('../../../../assets/BankLogos/GwangjuJeonbukBank(광주,전북은행).png'),
  JEONBUK: require('../../../../assets/BankLogos/GwangjuJeonbukBank(광주,전북은행).png'),
  TOSS: require('../../../../assets/BankLogos/TossBank(토스뱅크).png'),
  SAVINGS: require('../../../../assets/BankLogos/SBIBank(SBI저축은행).png'),
  SC: require('../../../../assets/BankLogos/SCBank(SC제일은행).png'),
  CITI: require('../../../../assets/BankLogos/CitiBank(시티은행).png'),
  KDB: require('../../../../assets/BankLogos/KDBBank(KDB산업은행).png'),
  CREDIT: require('../../../../assets/BankLogos/CreditUnion(신협).png'),
  KYONGNAM: require('../../../../assets/BankLogos/KyongnamBusanBank(경남,부산은행).png'),
  JEJU: require('../../../../assets/BankLogos/ShinhanJejuBank(신한,제주은행).png'),
};
