...
const styles = StyleSheet.create({
  ...
  romantic_playerProgressWrap: {
    paddingHorizontal: 4,
    marginBottom: 22,
  },
  romantic_playerProgressTrack: {
    width: '100%',
    height: 2,
    backgroundColor: 'rgba(90,70,62,0.18)',
    borderRadius: 1,
    position: 'relative',
  },
  romantic_playerProgressFill: {
    position: 'absolute',
    left: 0,
    top: 0,
    height: '100%',
    backgroundColor: 'rgba(90,70,62,0.55)',
    borderRadius: 1,
  },
  romantic_playerProgressDot: {
    position: 'absolute',
    top: -4,
    width: 10,
    height: 10,
    borderRadius: 5,
    backgroundColor: '#5A463E',
  },
  romantic_playerControls: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    paddingHorizontal: 8,
  ...
  romantic_playerPlayBtn: {
    width: 62,
    height: 62,
    borderRadius: 31,
    borderWidth: 1.8,
    borderColor: 'rgba(90,70,62,0.5)',
    alignItems: 'center',
    justifyContent: 'center',
  },
  // 구형 스타일 (하위 호환)
  romantic_introContent: { alignItems: 'center', zIndex: 2 },
  romantic_subtitle: { fontSize: 12, color: '#C2B0A2', letterSpacing: 3, marginBottom: 10 },
  romantic_loveText: { fontFamily: 'Great Vibes', fontSize: 72, color: '#9B8D82', marginVertical: 15, fontWeight: '400' },
  romantic_mainImageContainer: { width: width * 0.95, maxWidth: 420, height: 650, borderRadius: 320, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, overflow: 'hidden', marginTop: 20 },
  romantic_mainPhoto: { width: '100%', height: '100%' },
